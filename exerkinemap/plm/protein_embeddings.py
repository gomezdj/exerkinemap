...
class ProteinEmbeddingModel:
    """Simple embedding model wrapper for protein sequences."""
...
def compute_protein_embeddings(sequences: Iterable[str], embedding_dim: int = 64) -> np.ndarray:
